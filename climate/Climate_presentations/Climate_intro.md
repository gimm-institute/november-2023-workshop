...
* Error bars around all long-term climate-economic scenarios are huge
	* *The 7 NGFS scenarios have been generated by 3 different integrated assessment models* ([source][https://www.ngfs.net/ngfs-scenarios-portal/explore])
* ADD CHART OF NGFS SCENARIO UNCERTAINTY HERE - impact on CZ GDP
* Data is not there
	* We have cross-country data, but that is quite noisy
	* We do not have relevant historical data to tease out impact of warming
* Data might not be relevant due to technological change
...
---
### We should do something, but we don't quite know what yet
...
- We have *some* idea what will happen, but also *large uncertainty*, especially about the long-term economic impacts
- Technology is helping transition away from fossil fuels, but not fast enough to prevent large increase in global temperatures
- Curse of the horizon
- Impact on the economy is likely to be negative in aggregate, but unpredictable across sectors
	- We cannot foresee well technological advances
	- We do not know which mitigation and adaptation strategies will be implemented, and which will be successful

--- 
### Implications for macropru analysis and policy

* Work needs to be scenario-based
	* There is no relevant historical data
	* Policy and technological uncertainty, we don't really know which sectors will be impacted
